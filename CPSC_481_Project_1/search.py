...
def depth_first_graph_search(problem, h=None, display=False):
    """
    [Figure 3.7]
    Search the deepest nodes in the search tree first.
    Search through the successors of a problem to find a goal.
...
def breadth_first_graph_search(problem, h=None, display=False):
    """[Figure 3.11]
...
'''
def main():
    eight_puzzle = EightPuzzle(initial = (2, 3, 1, 4, 5, 7, 8, 6, 0), goal=(1, 2, 3, 4, 5, 6, 7, 8, 0))
